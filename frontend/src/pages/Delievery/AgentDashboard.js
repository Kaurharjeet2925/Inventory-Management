  ...
  <div className="mt-12 p-4 bg-gray-50 min-h-screen">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="md:hidden space-y-6">
        ...
        {[
          { key: "pending", label: "Pending", color: "orange", icon: <Clock className="w-6 h-6 text-orange-600" />, count: stats.pending },
          { key: "shipped", label: "Shipped", color: "blue", icon: <Truck className="w-6 h-6 text-blue-600" />, count: stats.shipped },
          { key: "delivered", label: "Delivered", color: "purple", icon: <PackageCheck className="w-6 h-6 text-purple-600" />, count: stats.delivered },
          { key: "completed", label: "Completed", color: "green", icon: <CheckCircle className="w-6 h-6 text-green-600" />, count: stats.completed },
        ].map((section) => (
          <div key={section.key}>
            ...
            <div
              ...
              className={`p-4 rounded-lg shadow cursor-pointer border-2 transition ${
                filter === section.key
                  ? `bg-${section.color}-100 border-${section.color}-500`
